...
module.exports = class __Component extends React.Component {
    render() {
        ...
        return React.DOM.li({ className: __class('category ' + this.props.project.tags[0]) }, React.DOM.h3(null, React.createElement(Link, {
            'to': '/portfolio/' + this.props.project.tags[0],
            'style': { 'text-transform': 'capitalize' }
        }, this.props.project.tags[0])), React.createElement(Link, {
